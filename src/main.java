...
public class main {
	...
	public static void main(String[] args) {
		...
		System.out.println("Digite o nnome da primeira pessoa: ");
		nome1 = sc .nextLine();
		System.out.println("Digite o salario da primeira pessoa: ");
		salario1 = sc.nextDouble();
		
		System.out.println("Digite o nnome da segunda pessoa: ");
		sc.nextLine();
		nome2 = sc .nextLine();
		System.out.println("Digite o salario da segunada pessoa: ");
